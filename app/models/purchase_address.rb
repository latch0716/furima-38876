class PurchaseAddress
  ...
  def save
    ...
    Address.create(postalcode: postalcode, prefecture_id: prefecture_id, city: city, block: block, building: building, phone_number: phone_number, purchase_id: purchase)
  end
